...
tmc4671_writeInt(0, TMC4671_ADC_I0_SCALE_OFFSET, 0x0100813F);
tmc4671_writeInt(0, TMC4671_ADC_I1_SCALE_OFFSET, 0x010081A8);

// Open loop settings *NEW*
...
tmc4671_writeInt(0, TMC4671_ABN_DECODER_MODE, 0x00001000); //DIFF
tmc4671_writeInt(0, TMC4671_ABN_DECODER_PPR, 0x00002000);
tmc4671_writeInt(0, TMC4671_ABN_DECODER_COUNT, 0x000019E4); //DIFF
...
tmc4671_writeInt(0, TMC4671_PID_VELOCITY_P_VELOCITY_I, 0x4E200320); //DIFF
