...
Lspi4671.writeByte(d.regs_4671["MOTOR_TYPE_N_POLE_PAIRS"],  [0x00,0x03,0x00,0x0F])
Lspi4671.writeByte(d.regs_4671["PWM_POLARITIES"],           [0x00,0x00,0x00,0x00])
Lspi4671.writeByte(d.regs_4671["PWM_MAXCNT"],               [0x00,0x00,0x0F,0x9F])
Lspi4671.writeByte(d.regs_4671["PWM_BBM_H_BBM_L"],          [0x00,0x00,0x28,0x28])
Lspi4671.writeByte(d.regs_4671["PWM_SV_CHOP"],              [0x00,0x00,0x00,0x07])

#ADC configuration
Lspi4671.writeByte(d.regs_4671["ADC_I_SELECT"],             [0x18,0x00,0x01,0x00])
Lspi4671.writeByte(d.regs_4671["dsADC_MCFG_B_MCFG_A"],      [0x00,0x10,0x00,0x10])
Lspi4671.writeByte(d.regs_4671["dsADC_MCLK_A"],             [0x20,0x00,0x00,0x00])
Lspi4671.writeByte(d.regs_4671["dsADC_MCLK_B"],             [0x20,0x00,0x00,0x00])
Lspi4671.writeByte(d.regs_4671["dsADC_MDEC_B_MDEC_A"],      [0x01,0x4E,0x01,0x4E])
Lspi4671.writeByte(d.regs_4671["ADC_I0_SCALE_OFFSET"],      [0x01,0x00,0x81,0x3F])
Lspi4671.writeByte(d.regs_4671["ADC_I1_SCALE_OFFSET"],      [0x01,0x00,0x81,0xA8])
