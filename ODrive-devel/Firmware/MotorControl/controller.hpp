...
public:
    ...
    void start_anticogging_calibration_f();
    void start_anticogging_calibration_b();
    float remove_anticogging_bias();
    bool anticogging_calibration_f(float pos_estimate, float vel_estimate);
    bool anticogging_calibration_b(float pos_estimate, float vel_estimate);
