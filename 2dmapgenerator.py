...
scale_factors = np.arange(90, 100, 10)
print(scale_factors)
resize_factors = np.arange(90, 100, 10)
...
for resize_factor in resize_factors:
    for scale_factor in scale_factors:
        ...
        out_fname = 'grid_map_{:s}_filtered_{:d}i_scale_{:d}_resize_{:d}_{:.2f}_{:.2f}'.format(seq_name, filter_ground_points, scale_factor, resize_factor, occupied_thresh, free_thresh)
        cv2.imwrite('./maps2d/{:s}.png'.format(out_fname), grid_map_resized)
