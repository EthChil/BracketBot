...
if __name__ == "__main__":
    ...
    moteus_control = Process(target=run_moteus, args=(termination_event, imu_setup, imu_shared_array, odometry_shared_array, input_value, orbslam_setup))
    uart_imu_process = Process(target=run_uart_imu_process, args=(termination_event, imu_setup, imu_shared_array))
    logging_process = Process(target=run_logging_process, args=(termination_event, imu_setup, imu_shared_array, odometry_shared_array))
