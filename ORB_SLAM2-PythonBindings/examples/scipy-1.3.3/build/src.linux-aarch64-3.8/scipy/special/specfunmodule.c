...
/*frompyobj*/
    ...
    bn_Dims[0]=1 + n;
    capi_bn_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.bernoa: failed to create array from the hidden `bn`";
    capi_bn_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,bn_Dims,bn_Rank,  capi_bn_intent,Py_None,capi_errmess);
    if (capi_bn_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*frompyobj*/
    ...
    const char * capi_errmess = "specfun.specfun.lpmns: failed to create array from the hidden `pm`";
    ...
    const char * capi_errmess = "specfun.specfun.lpmns: failed to create array from the hidden `pd`";
...
/*frompyobj*/
    ...
    const char * capi_errmess = "specfun.specfun.eulera: failed to create array from the hidden `en`";
...
/*decl*/
    ...
    const int cv_Rank = 1;
    PyArrayObject *capi_cv_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "specfun.specfun.cva1: failed to create array from the hidden `cv`";
    capi_cv_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,cv_Dims,cv_Rank,  capi_cv_intent,Py_None,capi_errmess);
    if (capi_cv_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = specfun_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        cv = (double *)(PyArray_DATA(capi_cv_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_cv_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_cv_as_array == NULL) ... else of cv */
...
/*frompyobj*/
    ...
    const char * capi_errmess = "specfun.specfun.lagzo: failed to create array from the hidden `x`";
    ...
    const char * capi_errmess = "specfun.specfun.lagzo: failed to create array from the hidden `w`";
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NN",capi_x_as_array,capi_w_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
...
/*frompyobj*/
    ...
    x_Dims[0]=n;
    capi_x_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.legzo: failed to create array from the hidden `x`";
    capi_x_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,x_Dims,x_Rank,  capi_x_intent,Py_None,capi_errmess);
    if (capi_x_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    w_Dims[0]=n;
    capi_w_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.legzo: failed to create array from the hidden `w`";
    capi_w_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,w_Dims,w_Rank,  capi_w_intent,Py_None,capi_errmess);
    if (capi_w_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*frompyobj*/
    ...
    qm_Dims[0]=1 + n;
    capi_qm_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.lqmns: failed to create array from the hidden `qm`";
    capi_qm_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,qm_Dims,qm_Rank,  capi_qm_intent,Py_None,capi_errmess);
    if (capi_qm_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    qd_Dims[0]=1 + n;
    capi_qd_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.lqmns: failed to create array from the hidden `qd`";
    capi_qd_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,qd_Dims,qd_Rank,  capi_qd_intent,Py_None,capi_errmess);
    if (capi_qd_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*frompyobj*/
    ...
    qn_Dims[0]=1 + n;
    capi_qn_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.lqna: failed to create array from the hidden `qn`";
    capi_qn_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,qn_Dims,qn_Rank,  capi_qn_intent,Py_None,capi_errmess);
    if (capi_qn_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    qd_Dims[0]=1 + n;
    capi_qd_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.lqna: failed to create array from the hidden `qd`";
    capi_qd_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,qd_Dims,qd_Rank,  capi_qd_intent,Py_None,capi_errmess);
    if (capi_qd_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*decl*/
    ...
    const int pl_Rank = 1;
    PyArrayObject *capi_pl_as_array = NULL;
...
/*frompyobj*/
    ...
    pn_Dims[0]=1 + n;
    capi_pn_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.lpni: failed to create array from the hidden `pn`";
    capi_pn_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,pn_Dims,pn_Rank,  capi_pn_intent,Py_None,capi_errmess);
    if (capi_pn_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    pd_Dims[0]=1 + n;
    capi_pd_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.lpni: failed to create array from the hidden `pd`";
    capi_pd_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,pd_Dims,pd_Rank,  capi_pd_intent,Py_None,capi_errmess);
    if (capi_pd_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "specfun.specfun.lpni: failed to create array from the hidden `pl`";
    capi_pl_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,pl_Dims,pl_Rank,  capi_pl_intent,Py_None,capi_errmess);
    if (capi_pl_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = specfun_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        pl = (double *)(PyArray_DATA(capi_pl_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NNN",capi_pn_as_array,capi_pd_as_array,capi_pl_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_pl_as_array == NULL) ... else of pl */
...
/*decl*/
    ...
    PyArrayObject *capi_dpl_as_array = NULL;
...
/*frompyobj*/
    ...
    pl_Dims[0]=1 + n;
    capi_pl_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.othpl: failed to create array from the hidden `pl`";
    capi_pl_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,pl_Dims,pl_Rank,  capi_pl_intent,Py_None,capi_errmess);
    if (capi_pl_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "specfun.specfun.othpl: failed to create array from the hidden `dpl`";
    capi_dpl_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,dpl_Dims,dpl_Rank,  capi_dpl_intent,Py_None,capi_errmess);
    if (capi_dpl_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = specfun_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        dpl = (double *)(PyArray_DATA(capi_dpl_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NN",capi_pl_as_array,capi_dpl_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_dpl_as_array == NULL) ... else of dpl */
...
/*frompyobj*/
    ...
    x_Dims[0]=n;
    capi_x_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.herzo: failed to create array from the hidden `x`";
    capi_x_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,x_Dims,x_Rank,  capi_x_intent,Py_None,capi_errmess);
    if (capi_x_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    w_Dims[0]=n;
    capi_w_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.herzo: failed to create array from the hidden `w`";
    capi_w_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,w_Dims,w_Rank,  capi_w_intent,Py_None,capi_errmess);
    if (capi_w_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*decl*/
    ...
    const int vv_Rank = 1;
    PyArrayObject *capi_vv_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "specfun.specfun.pbvv: failed to create array from the hidden `vv`";
    capi_vv_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,vv_Dims,vv_Rank,  capi_vv_intent,Py_None,capi_errmess);
    if (capi_vv_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = specfun_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        vv = (double *)(PyArray_DATA(capi_vv_as_array));

    /* Processing variable vp */
    vp_Dims[0]=2 + abs((int)v);
    capi_vp_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "specfun.specfun.pbvv: failed to create array from the hidden `vp`";
    capi_vp_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,vp_Dims,vp_Rank,  capi_vp_intent,Py_None,capi_errmess);
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NNdd",capi_vv_as_array,capi_vp_as_array,pvf,pvd);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    }  /* if (capi_vv_as_array == NULL) ... else of vv */
...
static FortranDataDef f2py_routine_defs[] = {
    ...
    {"bernoa",-1,{{-1}},0,0,(char *)  F_FUNC(bernoa,BERNOA),  (f2py_init_func)f2py_rout_specfun_bernoa,doc_f2py_rout_specfun_bernoa},
    {"lpmns",-1,{{-1}},0,0,(char *)  F_FUNC(lpmns,LPMNS),  (f2py_init_func)f2py_rout_specfun_lpmns,doc_f2py_rout_specfun_lpmns},
    {"eulera",-1,{{-1}},0,0,(char *)  F_FUNC(eulera,EULERA),  (f2py_init_func)f2py_rout_specfun_eulera,doc_f2py_rout_specfun_eulera},
    ...
    {"cva1",-1,{{-1}},0,0,(char *)  F_FUNC(cva1,CVA1),  (f2py_init_func)f2py_rout_specfun_cva1,doc_f2py_rout_specfun_cva1},
    ...
    {"lagzo",-1,{{-1}},0,0,(char *)  F_FUNC(lagzo,LAGZO),  (f2py_init_func)f2py_rout_specfun_lagzo,doc_f2py_rout_specfun_lagzo},
    {"legzo",-1,{{-1}},0,0,(char *)  F_FUNC(legzo,LEGZO),  (f2py_init_func)f2py_rout_specfun_legzo,doc_f2py_rout_specfun_legzo},
    ...
    {"lqmns",-1,{{-1}},0,0,(char *)  F_FUNC(lqmns,LQMNS),  (f2py_init_func)f2py_rout_specfun_lqmns,doc_f2py_rout_specfun_lqmns},
    {"chgm",-1,{{-1}},0,0,(char *)  F_FUNC(chgm,CHGM),  (f2py_init_func)f2py_rout_specfun_chgm,doc_f2py_rout_specfun_chgm},
    ...
    {"aswfb",-1,{{-1}},0,0,(char *)  F_FUNC(aswfb,ASWFB),  (f2py_init_func)f2py_rout_specfun_aswfb,doc_f2py_rout_specfun_aswfb},
    {"lqna",-1,{{-1}},0,0,(char *)  F_FUNC(lqna,LQNA),  (f2py_init_func)f2py_rout_specfun_lqna,doc_f2py_rout_specfun_lqna},
    ...
    {"lpni",-1,{{-1}},0,0,(char *)  F_FUNC(lpni,LPNI),  (f2py_init_func)f2py_rout_specfun_lpni,doc_f2py_rout_specfun_lpni},
    {"cyzo",-1,{{-1}},0,0,(char *)  F_FUNC(cyzo,CYZO),  (f2py_init_func)f2py_rout_specfun_cyzo,doc_f2py_rout_specfun_cyzo},
    {"othpl",-1,{{-1}},0,0,(char *)  F_FUNC(othpl,OTHPL),  (f2py_init_func)f2py_rout_specfun_othpl,doc_f2py_rout_specfun_othpl},
    ...
    {"herzo",-1,{{-1}},0,0,(char *)  F_FUNC(herzo,HERZO),  (f2py_init_func)f2py_rout_specfun_herzo,doc_f2py_rout_specfun_herzo},
    {"pbvv",-1,{{-1}},0,0,(char *)  F_FUNC(pbvv,PBVV),  (f2py_init_func)f2py_rout_specfun_pbvv,doc_f2py_rout_specfun_pbvv},
...
PyMODINIT_FUNC PyInit_specfun(void) {
    ...
    s = PyUnicode_FromString(
        "This module 'specfun' is auto-generated with f2py (version:1.24.2).\nFunctions:\n"
"    cqm,cqd = clqmn(m,n,z)\n"
"    qm,qd = lqmn(m,n,x)\n"
"    cpm,cpd = clpmn(m,n,x,y,ntype)\n"
"    n,m,pcode,zo = jdzo(nt)\n"
