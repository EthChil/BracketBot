...
/*frompyobj*/
    ...
    const char * capi_errmess = "_nnls._nnls.nnls: failed to create array from the 4th argument `b`";
    ...
    const char * capi_errmess = "_nnls._nnls.nnls: failed to create array from the 5th argument `w`";
    ...
    const char * capi_errmess = "_nnls._nnls.nnls: failed to create array from the 6th argument `zz`";
    ...
    const char * capi_errmess = "_nnls._nnls.nnls: failed to create array from the 7th argument `index_bn`";
