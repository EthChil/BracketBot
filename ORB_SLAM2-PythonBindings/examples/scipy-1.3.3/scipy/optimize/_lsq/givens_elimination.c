 ...
 * 
 */
  __pyx_tuple__19 = PyTuple_Pack(15, __pyx_n_s_S, __pyx_n_s_v, __pyx_n_s_diag, __pyx_n_s_n, __pyx_n_s_k, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_f, __pyx_n_s_g, __pyx_n_s_r, __pyx_n_s_cs, __pyx_n_s_sn, __pyx_n_s_one, __pyx_n_s_diag_row, __pyx_n_s_u); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 12, __pyx_L1_error)
