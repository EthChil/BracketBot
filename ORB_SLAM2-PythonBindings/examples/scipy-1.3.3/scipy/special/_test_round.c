 ...
 */
      __pyx_t_8 = (__Pyx_PyUnicode_Equals(__pyx_v_mode, __pyx_n_u_up, Py_EQ)); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 63, __pyx_L9_error)
      if (__pyx_t_8) {
 ...
 */
      __pyx_t_8 = (__Pyx_PyUnicode_Equals(__pyx_v_mode, __pyx_n_u_down, Py_EQ)); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 66, __pyx_L9_error)
      if (likely(__pyx_t_8)) {
 ...
 *     if nfail:
 */
      __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_u_21g_21g_21g_21g, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 81, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
 ...
 *         assert_(False, "\n".join(msg))
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_u_failures_with_mode, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_31 = NULL;
    __pyx_t_7 = 0;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_29 = PyUnicode_Join(__pyx_kp_u__4, __pyx_v_msg); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_29);
    __pyx_t_31 = NULL;
    __pyx_t_7 = 0;
 ...
 *             if mode == 'up':
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Couldn_t_get_rounding_mode); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 61, __pyx_L1_error)
 ...
 *                 raise RuntimeError("Failed to set rounding mode")
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_Invalid_rounding_mode); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 70, __pyx_L1_error)
 ...
 *         finally:
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_u_Failed_to_set_rounding_mode); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 72, __pyx_L1_error)
